...
\includegraphics{kaggle/output/overview}
    \end{adjustbox}
...
%  \includegraphics[width=0.8\linewidth]{figures//framework.pdf}
    \includegraphics{duplicate and missing.png}
\end{tikzfigure}
\vspace{2cm}
\begin{description}
...
\begin{center}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[scale=0.3]{outliers1.png}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[scale=0.3]{outliers2.png}
    ...
    \centering
    \begin{tikzfigure}
   \includegraphics[scale=0.3]{outliers3.png}
...
\begin{tikzfigure}%[Overall architecture of \emph{GOAM} algorithm]
     \includegraphics[scale=0.9]{trip_duration.png}
...
\end{tikzfigure}
  ...
  \begin{tikzfigure}%[Overall architecture of \emph{GOAM} algorithm]
  	\includegraphics{speed.png}
  	{\small{speed}}
  \end{tikzfigure}
  \item
  \emph{Correlations and dimensionality reductions}
  \begin{tikzfigure}%[Overall architecture of \emph{GOAM} algorithm]
  	\includegraphics{correlations between variables.png}
...
\begin{description}
  ...
  \begin{tikzfigure}%[Overall architecture of \emph{GOAM} algorithm]
  	\includegraphics{predict_result.png}
...
{ \centering
 The $11^{th}$ Flip00-kaggle project, Beijing, China
}
\end{minipage}
}
%%%%%%%%%% -------------------------------------------------------------------- %%%%%%%%%%
